<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    ...
    <head>
        ...
        <title>Developer Registration - PlayStore</title>
    ...
    <body>
        ...
        <div class="register-container">
            <div class="register-card">
                ...
                <p class="subtitle">Create your developer account to start publishing apps</p>
                ...
                <form id="registerForm">
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="text" id="userName" name="userName" placeholder="johndoe_dev" required>
                        </div>
                        <div class="form-group">
                    ...
                    <button type="submit" class="btn-register" id="registerBtn">Create Developer Account</button>
                </form>

                <div class="divider"><span>Already a developer?</span></div>

                <p class="login-link"><a href="/login">Sign in instead →</a></p>
            </div>
        </div>
        ...
        <script>
            ...
            form.addEventListener('submit', async (e) => {
                ...
                try {
                    ...
                    registerBtn.textContent = 'Create Developer Account';
                }
            });
        </script>
    </body>
